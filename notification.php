            ...
            <div class="card-body">
              <form action="https://finance-zgvt.onrender.com/email" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" required class="form-control" id="subject" name="subject" placeholder="Enter subject">
                </div>

                <div class="form-group">
                  <label for="message">Message:</label>
                  <textarea class="form-control" required id="message" name="message" rows="4" placeholder="Enter your message"></textarea>
                </div>
